        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stall = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RequiresEnar5147 = table.Column<bool>(type: "bit", nullable: false),
                    LastInseminationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    InseminationBullKlsz = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BloodTestTubeNumber = table.Column<int>(type: "int", nullable: true),
                    LastBloodTestDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightGain = table.Column<double>(type: "float", nullable: false),
                    OldAgeGroup = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NewAgeGroup = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OldHerdId = table.Column<int>(type: "int", nullable: true),
                    NewHerdId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnimalHistories_Cattles_CattleId",
                        column: x => x.CattleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnimalHistories_CattleId",
